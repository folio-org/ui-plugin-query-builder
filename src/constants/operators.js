...
export const OPERATOR_GROUPS = {
  ...
  arrayCompression: [OPERATORS.IN, OPERATORS.NOT_IN, OPERATORS.CONTAINS_ALL, OPERATORS.CONTAINS_ANY, OPERATORS.NOT_CONTAINS_ANY, OPERATORS.NOT_CONTAINS_ALL,  OPERATORS.NOT_CONTAINS],
}
